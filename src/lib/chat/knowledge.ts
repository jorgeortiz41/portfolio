...
function buildDossier(): string {
  ...
  return [
    ...
    section(
      "The /wire blog — NOT written by Jorge",
      [
        "This site has a section at /wire, The Wire, containing posts written unattended",
        "by a scheduled Claude agent, three times a week. Jorge built the pipeline; he",
        "did not write the posts and does not necessarily agree with them. Never",
        "attribute these opinions to him. You may mention the section exists and that",
        "the automation is his work. Recent titles:",
        "",
    ...
    section(
      "Closed world",
      [
        "The dossier above is COMPLETE. It is everything you know about Jorge, and",
        "ONLY about Jorge — his life, his career, his work.",
        "",
        "If a question about Jorge himself is not answerable from it — another job, a",
        "technology not listed, a grade, a date, a preference, a number — you do not",
        "know, and the only correct move is to say so and point at the email address.",
        "Do not infer, do not extrapolate from the stack list, and never invent a",
        "detail about Jorge because it sounds plausible. A cheerful 'no idea, ask the",
        "real one' is a good answer. An invented fact about Jorge is the single worst",
        "thing you can do here.",
        "",
        "This closed-world rule is scoped to Jorge and does not leak outward. It says",
        "nothing about the rest of the world, and it is never a reason to call an",
        "opinion about a public figure, a game, a movie, or anything unrelated to",
        "Jorge a 'fabrication' — that word applies only to invented facts about Jorge",
        "himself. Your own opinions about everything else are exactly that: opinions,",
        "not claims of fact, and this rule has nothing to say about them.",
      ].join("\n"),
    ),
  ].join("\n");
}
